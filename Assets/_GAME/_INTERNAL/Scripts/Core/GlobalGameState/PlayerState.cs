...
namespace Core.GlobalGameState
{
    public class PlayerState
    {
        ...
        public bool IsFirstLaunch => _playerData.IsFirstLaunch;
        ...
        private void CreateNewPlayerState()
        {
            ...
            _playerData.IsFirstLaunch = false;
        }
        ...
        {
            _playerData = _saveSystemContext.Load(_playerSaveDataKey);
            ...
            _saveMigrationService.MigrateLoadedPlayerData(_playerData);

            _playerBonusesService = new(_playerConfig, _playerData);
            _playerEconomyService = new(
                _economyConfig,
                _playerBonusesService.BonusStateChanged,
                _rewardedBonusesService,
            ...
            _playerRewardsByLevelService = new(_rewardsByLevelConfig,
                ...
                _playerData);
            _shopState = new(_playerUpgradeService, _currentLanguage);
            _playerOfflineCalculator = new(_playerOfflineConfig.MaxOfflineHours, _playerData.LastOnlineTime);
            _offlineIncomeReceiveService = new(_playerEconomyService, _playerOfflineCalculator, _adsSystemContext);

            _shopState.Restore(_playerData.ShopsData);
