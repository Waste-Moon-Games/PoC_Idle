...
namespace UI.Common.Components
{
    public class ActionButtonsAnimationsService : MonoBehaviour
    {
        ...
        [SerializeField] private Vector2 _waveTargetScale = new(1.1f, 1.1f);
        [SerializeField] private float _waveDelay = 0.45f;
        [SerializeField] private float _waveDuration = 0.75f;
        [SerializeField] private float _delayBetweenWaves = 2.5f;
